...
def use_loot(belt, hero):
    """Original function to automatically use the first item. Kept for reference but replaced by check_crafting."""
    good_loot_options = ["Health Potion", "Leather Boots"] # Note: Leather Boots didn't actually do anything here
...
def adjust_combat_strength(hero, monster):
    ...
    if last_game:
        ...
        if "Hero" in last_game and "gained" in last_game and "stars" in last_game:
            ...
            print("    |    ... Previous game result unclear or draw. No combat strength adjustment.")
    else:
        print("    |    ... No previous game history found. No combat strength adjustment.")
